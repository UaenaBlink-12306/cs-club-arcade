...
export const games: GameMeta[] = [
  { id: 'air-hockey', title: 'NEON AIR HOCKEY', shortTitle: 'HOCKEY', description: 'Strike the puck. First to five wins.', players: 2, controls: ['P1 · WASD', 'P2 · ARROW KEYS'], accent: '#18d8f2', recordLabel: 'WINS', recordStrategy: 'count', formatRecord: (score) => `${score} WINS` },
